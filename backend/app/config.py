...
class Settings:
    ...
    flight_mqtt_tls_enabled: bool = _env_bool("FLIGHT_MQTT_TLS_ENABLED", False)
    flight_mqtt_tls_insecure: bool = _env_bool("FLIGHT_MQTT_TLS_INSECURE", False)
    flight_mqtt_tls_ca_cert: str = os.getenv("FLIGHT_MQTT_TLS_CA_CERT", "")
    flight_mqtt_tls_certfile: str = os.getenv("FLIGHT_MQTT_TLS_CERTFILE", "")
    flight_mqtt_tls_keyfile: str = os.getenv("FLIGHT_MQTT_TLS_KEYFILE", "")
