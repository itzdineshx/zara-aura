...
export async function sendVoiceChunk(audioChunk: Blob, mode: ResponseMode): Promise<VoiceApiResponse> {
...
export async function sendChatMessage(text: string, mode: ResponseMode, volume = 0): Promise<ChatApiResponse> {
